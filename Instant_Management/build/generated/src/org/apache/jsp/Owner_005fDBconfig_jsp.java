...
public final class Owner_005fDBconfig_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//SQl Statements------------------------User---------------------------------
        insertUser=connection.prepareStatement("INSERT INTO Owner(Owner_Name)"
        + "VALUES (?)"); 

        selectUser = connection.prepareCall("SELECT Owner_ID, Owner_Namer From Owner");
        UpdateUserName = connection.prepareStatement("UPDATE Owner SET Owner_Namer = ? " + "WHERE Owner_ID = ? ");
