...
<html>
    ...
    <body> 
        ...
        <form name="add_comment" onsubmit="return validateConversationForm()" action="Bug_Conversation.jsp" method="POST">
        ...
        <script type="text/javascript">
            function validateConversationForm()
            {
                ...
                var a=document.forms["add_comment"]["comment"].value.trim();
                var b=document.forms["add_comment"]["owner"].value.trim();
    
                if ((a==null || a=="") &&  (b==null || b==""))
                {
                    alert_message="Please Fill In Comment Field and Select A User";
                    alert(alert_message);
                    return false;
                ...
                {
                    alert_message="Please Fill In Comment Field";
                    alert(alert_message);
                    return false;
                }
                else if(b==null || b=="")
                {
                    alert_message="Please Select A Valid A User";
                    alert(alert_message);
                    return false;
                }
            }       
