...
<html>
                    ...
                    <td><%=Bug_Priority%>
                        <select name="UpdateBugPriority">
                            <%
                                ...
                                if(Bug_Priority.equals("Low"))
                                {
                                    Priority1="Low";
                                    Priority2="Medium";
                                    Priority3="Hard";
                                }
                                if(Bug_Priority.equals(null))
                                {
                                    Priority1="Low";
                                    Priority2="Medium";
                                    Priority3="Hard";
            ...
            <tbody>
                <tr>
                    ...
                    <%    
                        ...
                        //refresh page and then for to buglog view
                        if(request.getParameter("search_story_id2")!=null)
                        {   
                    %> 
                            <script type="text/javascript">
                                document.forms["Bug_Update2"].submit();
                            </script> 
                    <%    
                        }
                    %>
    ...
    <%
        ...
        {
    %>
            <form name="Bug_Update2" action="Buglog_ViewDB.jsp" id="form_id" method="POST">
    <%
                if  (request.getParameter("search_story_id2")!=null) 
                {
                    if(!request.getParameter("UpdateBugTitle").equals("Bug_Title"))
