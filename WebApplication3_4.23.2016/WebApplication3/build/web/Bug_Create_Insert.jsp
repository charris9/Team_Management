...
<html>
    ...
    <body onload="displayResults()" >
        <div class="main-window">
            ...
            <form name= "myform" onsubmit="return validateBugCreateForm()" action="Bug_Create_Insert.jsp" method="POST">
                <table border="0">
                    <tbody> 
                        <tr>
                            <td>Bug Title : </td>
                            <td>
                                <input type="text" name="bug_title" value="" size="50"  />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="bug_description" value = "" size="50"/>
            ...
            <script LANGUAGE = "JavaScript">
                ...
                {
                    if((document.myform.hidden.value == 1)&&validateBugCreateForm())
                    {
